...
public class Edit_Reception extends JFrame implements ActionListener{
    ...
    Edit_Reception(String username){
        ...
        try{
            ...
            if(rest.next()){
                ...
                ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("hmis\\Hospital\\Images\\Recept.jpg"));
                Image i = img.getImage().getScaledInstance(800, 600, Image.SCALE_SMOOTH);
                ImageIcon img1 = new ImageIcon(i);
                l1.setIcon(img1);

                l2= new JLabel("Receptionist Details");
                ...
                try{
                    ...
                    while(rest1.next()){
                        ...
                        t7.setText(rest1.getString("qualification"));
                        l1.add(t7);
                        ...
                        t11.setText(rest1.getString("joining_date"));
                        l1.add(t11);
                ...
                JOptionPane.showMessageDialog(null, "Record not found, Please fill the right Receptionist! ");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==bt1){
             ...
             try{
                 ConnectionClass obj = new ConnectionClass();
                 String q = "update receptionist set name='"+name+"',email='"+email+"',father_name='"+father_name+
                         "',phone='"+phone+"',qualification='"+qualification+"',city='"+city+"',gender='"+gender+
                         "',blood='"+blood+"',joining_date='"+joining_date+"',age='"+age+"',address='"+address+
